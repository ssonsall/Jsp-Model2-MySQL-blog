...
<section class="contact_area">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<form class="row contact_form" action="/blog/user?cmd=jointest" method="post" onsubmit="return validateCheck()" enctype="multipart/form-data">
					<div class="col-md-12">
						<div class="form-group">
							<input type="text" class="form-control" name="username" required="required" maxlength="20" placeholder="Enter Your ID">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
					...
					<div class="col-md-10">
						<div class="form-group">
							<input type="text" class="form-control" id="roadFullAddr" name="address" required="required" placeholder="Search Your Address" readonly>
						</div>
					</div>
					<div class="col-md-2">
