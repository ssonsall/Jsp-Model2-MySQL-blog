		...
		<div class="row">
			<div class="col-lg-12">
				<form class="row contact_form" action="/blog/user?cmd=join" method="post" onsubmit="return validateCheck()" enctype="multipart/form-data">
					...
					<div class="col-md-5">
						<div class="form-group" style="margin-bottom: 0px">
							<input type="text" class="form-control" id="username" name="username" onkeyup="usernameDuplicationCheck()" required="required" maxlength="20" placeholder="Enter Your ID">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group" style="margin-bottom: 0px">
...
<!-- 					<div class="col-md-4">
					...
					<div class="col-md-5">
						<div class="form-group">
							<input type="text" style="cursor: pointer;" onClick="goPopup()" class="form-control" id="roadFullAddr" name="address" required="required" placeholder="Search Your Address" readonly>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
